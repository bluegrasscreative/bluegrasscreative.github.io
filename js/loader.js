! function e(t, i, s) {
    ...
    6: [function(e, t) {
        function i(e) {
            "use strict";
            this.parentElement = e, this.idName = "qLoverlay", this.percentageId = "qlPercentage", this.className = "queryloader__overlay", this.element = null, this.loadingBar = null, this.percentage = null, this.barColor = "#ff0000", this.backgroundColor = "#000", this.barHeight = 1, this.fadeOutTime = 600, this.showPercentage = !1
        }
    ...
    8: [function(e, t) {
        ...
        i.prototype.init = function() {
            ...
            "use strict";
            this.overlay.updateProgress(e / t * 100, this.options.minimumTime), e === t && this.done === !1 && (window.clearTimeout(this.maxTimeout), window.setTimeout(this.doneLoading.bind(this), this.options.minimumTime))
